...
const SignUpCard = ({ children }) => {
  ...
  const image = { src: signUpImage, alt: t('signUpPage.registration') };

  const footer = { text: t('signUpPage.alreadyHave'), hrefText: t('signUpPage.login'), href: pageRoutes.loginPage() };
